...
export const register = async (req, res) => {
  try {
    console.log("Hi there from backend in Registration")
    ...
    console.log(err);
    res.status(500).json({ success: false, message: "Not Created. Try again from backend" });
  }
};
...
export const login = async (req, res) => { // async function 
  ...
  console.log("Hi there from backend in Login")
